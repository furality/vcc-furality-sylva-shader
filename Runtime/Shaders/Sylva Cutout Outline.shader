...
Shader "Furality/Sylva Shader/Sylva Cutout Outline"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 temp_cast_268 = (( 0.4 + (-0.5 + (Noise50_g5027 - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) )).xx;
			float2 temp_output_54_0_g5027 = ( abs( UV45_g5027 ) - temp_cast_268 );
			float2 temp_cast_269 = (( 0.4 + (-0.5 + (Noise50_g5027 - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) )).xx;
			...
			float3 lerpResult20_g5030 = lerp( temp_cast_281 , lerpResult17_g5036 , (float)temp_output_21_0_g5030);
			...
			float3 lerpResult22_g5030 = lerp( temp_cast_285 , lerpResult17_g5038 , (float)temp_output_21_0_g5030);
			...
			float4 lerpResult52_g5030 = lerp( temp_cast_295 , lerpResult14_g5040 , (float)saturate( EmissionGlowZone47_g5030 ));
			...
			float4 EmissionGlow142_g5030 = ( (temp_cast_300 + (lerpResult51_g5030 - float4( 0,0,0,0 )) * (temp_cast_301 - temp_cast_300) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) * _SparkleGlowTint * temp_output_258_0_g5030 );
			float4 lerpResult261_g5030 = lerp( temp_cast_280 , EmissionGlow142_g5030 , (float)temp_output_258_0_g5030);
			...
			float4 lerpResult268_g5030 = lerp( temp_cast_312 , _SparkleReactiveTint , (float)step( EmissionReactiveBand243_g5030 , 9 ));
			...
			float4 lerpResult275_g5030 = lerp( temp_cast_278 , ( lerpResult280_g5030 * SparkleAlpha129_g5027 ) , localIfAudioLinkv2Exists1_g5045);
...
ASEEND*/
//CHKSM=EECB98E28838265AE4410B0627DC3689DC66AB0C